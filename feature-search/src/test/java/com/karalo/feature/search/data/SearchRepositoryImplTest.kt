...
class SearchRepositoryImplTest {
    ...
    @Test
    fun `search maps YouTube client summaries onto domain results`() =
        runTest {
            fakeClient.searchResult =
                AppResult.Success(
            ...
            val expected =
                listOf(
                    com.karalo.feature.search.domain.SearchResultItem(
                        "abc",
                        "Karaoke Song",
                        "Some Channel",
                        "https://thumb",
    ...
    @Test
    fun `suggestions maps YouTube client suggestions onto plain strings`() =
        runTest {
