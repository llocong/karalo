    ...
    reports {
        verify {
            rule {
                ...
                // raise it to make CI pass. Lowered 20 -> 19 -> 18 -> 17 -> 16 as the brand theme
                // (fonts, palette, nav rail redesign, logo), the nav rail's focus-vs-click
                // behavior, restoring focus to the last-played video, and RIGHT-as-OK on a focused
                // rail item landed, for the same reason each time: more untested-by-design UI code.
                minBound(16)
            }
        }
    }
