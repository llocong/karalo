    ...
    reports {
        verify {
            rule {
                ...
                // raise it to make CI pass. Lowered 20 -> 19 -> 18 -> 17 -> 16 -> 15 as the brand
                // theme (fonts, palette, nav rail redesign, logo), the nav rail's focus-vs-click
                // behavior, restoring focus to the last-played video, RIGHT-as-OK on a focused rail
                // item, and fixes to the Home/Settings nav-rail focus-restoration races landed, for
                // the same reason each time: more untested-by-design UI code.
                minBound(15)
            }
        }
    }
